...
pub use crate::ntdef::{
    CLONG, PCCHAR, PCSHORT, PCLONG, PCSZ, PPVOID, KIRQL, PKIRQL,
    ...
    PCANSI_STRING, PCOEM_STRING, PKSYSTEM_TIME, _KSYSTEM_TIME, OBJECT_ATTRIBUTES,
    LOGICAL, PCLIENT_ID, CLIENT_ID64,
    PUNICODE_STRING, PCUNICODE_STRING, POBJECT_ATTRIBUTES
};
